...
1. Once the container starts the runtime passes some information to the CNI plugin, things like the name of the network interface assigned to the container so the plugin can do its thing.
