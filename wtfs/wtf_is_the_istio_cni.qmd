...
[![Container network interface.](media/container-network-interface.png "A cardboard takeout box with an ethernet jack on the side."){width=80% #fig-cni}](https://unsplash.com/photos/small-brown-cardboard-box-with-handle-5R5Trsu1aIM)
:::
